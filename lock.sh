...
convert -blur 0x6 /tmp/screen.png -paint 1 -swirl 120 /tmp/screen.png

# Add the lock to the blurred image:
[[ -f ~/.config/i3/lock.png ]] && convert /tmp/screen.png  ~/.config/i3/rick-and-morty.png -gravity center -composite -matte /tmp/screen.png
